...
class Bank:
    ...
    def __init__(self):
        ...
        self.file_storage = PersistenceUtils
        pass
    ...
    def save_data(self, bank_file, data):
        PersistenceUtils.write_pickle(bank_file, data)

    def load_data(self, bank_file):
        PersistenceUtils.load_pickle(bank_file)
...
class PersistenceUtils:
    ...
    @staticmethod
    def write_pickle(filename, input_stuff):
        # writes pickle
        a = input_stuff
